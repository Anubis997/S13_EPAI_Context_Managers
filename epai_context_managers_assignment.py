# -*- coding: utf-8 -*-
"""EPAI_Context_Managers_Assignment.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1K5TW1clhgIHw9IUJQbA4QFHU7HauegKH
...
csv_file_1 = '/content/nyc_parking_tickets_extract.csv'
with csv_context_manager(csv_file_1) as rows:
  for row in rows:
    print(row)
